...
export default function NamedDynamic() {
  return (
    <div>
      ...
      <button type="button" onClick={() => setLayoutProps('app', { title: 'Updated App Title' })}>Update App Title</button>
      <button type="button" onClick={() => setLayoutProps('content', { padding: 'xl' })}>Update Content Padding</button>
      <button type="button" onClick={() => {
        setLayoutProps({ title: 'Shared Title' })
        setLayoutProps('app', { title: 'Named Title' })
      }}>Set competing titles</button>
      <button type="button" onClick={resetLayoutProps}>Reset Layout Props</button>
